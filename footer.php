...
<script type="text/javascript">
		$( document ).ready(function() {
		  ...
		  $(".video-thumb").click(function() {
		      ...
		      $('html, body').animate({
			        scrollTop: $("#video-main-wrapper").offset().top -150
			    }, 500);
...
<script type="text/javascript">
		...
		$('#start').on('click', function() {
			...
			$( "#start-wrapper" ).hide();
			$( "#stop-wrapper" ).show().addClass( "tada" );
		});
		...
		<?php if (is_page( 'flab2lean-catch-up-sessions' ) ): ?>
			  ...
			  <script>
					...
					$current_page = "flab2lean-catch-up-sessions"
					$( document ).ready( function() {
		...
		<?php if (is_page( 'f2l-premium-program' ) ): ?>
			  ...
			  <script>
				...
				$( "#stop" ).click(function() {
					...
					$('.timer').timer('pause');
					var str = $( "#divId" ).text();
					$( "#submit-wrapper" ).html( '<a href="<?php bloginfo("url"); ?>/f2l-premium-leaderboard/?myNumber='+str+' " class="button SubmitButton" id="submit">Submit</a>');
				});
		...
		<?php if (is_page( 'flab2lean-level-one' ) ): ?>
			  ...
			  <script>
				...
				$( "#stop" ).click(function() {
					...
					$('.timer').timer('pause');
					var str = $( "#divId" ).text();
					$( "#submit-wrapper" ).html( '<a href="<?php bloginfo("url"); ?>/flab2lean-level-one-leaderboard/?myNumber='+str+' " class="button SubmitButton" id="submit">Submit</a>');
				});
