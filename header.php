...
<script src="<?php bloginfo('url'); ?>/wp-content/themes/zerif-pro/js/timer.jquery.min.js"></script>

<link href="https://fonts.googleapis.com/css?family=Squada+One" rel="stylesheet">

<?php if (is_page( array('primal-teens','flab2lean-booking-page', 'primal-kidz', 'team-primal', 'primalcubz', 'primal-cubz-try-day')) ): ?>
...
?>
		...
		<header id="home" class="header" itemscope="itemscope" itemtype="http://schema.org/WPHeader" role="banner">
			...
			<div id="main-nav" class="navbar navbar-inverse bs-docs-nav">
				...
				<div class="container">
				<!-- Header Text Primal Training-->
					<div class="header-strap">Home to Yorkshire's leading weight transformation course <span>FLAB</span>2<span>LEAN</span></div>
